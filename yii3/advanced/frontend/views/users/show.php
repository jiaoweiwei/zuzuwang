            ...
            <table border="1" class="table table-striped table-bordered table-hover">
                ...
                <?php foreach($data as $key=>$val){?>
                    <tr id="<?php echo $val['user_id']?>">
                        ...
                        <td>
                            <?php echo $val['user_time']?>
                        </td>
                        <td>
                            <button class="btn btn-xs btn-info" onclick="javascript:window.location.href='?r=users/upda&user_id=<?php echo $val['user_id']?>'">
                                <i class="icon-edit bigger-120"></i>
                            </button>
                            <button class="btn btn-xs btn-danger"  onclick="javascript:window.location.href='?r=users/del&user_id=<?php echo $val['user_id']?>'">
                                <i class="icon-trash bigger-120"></i>
                            </button>
                            <button class="btn btn-xs btn-warning"  onclick="javascript:window.location.href='?r=users/authority&user_id=<?php echo $val['user_id']?>'">
